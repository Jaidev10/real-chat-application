...
<div class="flex min-h-screen">
    <!-- Left side - Hero image/info (same as login page) -->
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                ...
                <div id="register-error" class="hidden bg-red-100 text-red-600 p-3 rounded-lg mb-4"></div>
                
                <form id="register-form" class="space-y-4">
                    <div>
                        <label for="username" class="block text-sm font-medium text-gray-700 mb-1">Username</label>
                        <input type="text" id="username" name="username" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500" required>
                    </div>
                    ...
                    <div>
                        <button type="submit" id="register-button" class="w-full bg-primary-600 hover:bg-primary-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200 flex items-center justify-center">
                            <span>Create Account</span>
                            <div id="register-spinner" class="ml-2 spinner hidden"></div>
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">Already have an account? 
                        <a href="index.php" class="text-primary-600 hover:text-primary-800 font-medium">Login</a>
                    </p>
                </div>
            </div>
            
            <div class="mt-8 text-center text-sm text-gray-500">
                <p>© 2023 TeamChat. All rights reserved.</p>
            </div>
        </div>
    </div>
</div>
